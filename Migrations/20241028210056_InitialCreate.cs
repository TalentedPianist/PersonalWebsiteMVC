        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentAuthorEmail = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GuestbookAuthor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GuestbookAuthorEmail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GuestbookAuthorUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GuestbookContent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GuestbookAuthorIP = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GuestbookApproved = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostLocation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PostIP = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PostActive = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PostPublished = table.Column<bool>(type: "bit", nullable: true),
