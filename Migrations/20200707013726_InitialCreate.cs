        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GuestbookID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GuestbookComment = table.Column<string>(nullable: false),
                    GuestbookUser = table.Column<string>(nullable: false),
                    GuestbookUserEmail = table.Column<string>(nullable: false),
                    GuestbookUserWebsite = table.Column<string>(nullable: true),
                    GuestbookApproved = table.Column<string>(nullable: true),
                    GuestbookIP = table.Column<string>(nullable: true),
                    GuestbookDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostLocation = table.Column<string>(nullable: true),
                    PostIP = table.Column<string>(nullable: true),
                    PostActive = table.Column<string>(nullable: true),
